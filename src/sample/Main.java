...
public class Main extends Application {
    ...
    /**
     * This method creates the example UML Sequence Diagram given to us. We must make a vsdx file from this object.
     * @throws UMLSDStructureException
     */
    private void initUMLExample() throws UMLSDStructureException {
        umlSD = new UMLSequenceDiagram();
        ...
        UMLCreateMessage addToppings = new UMLCreateMessage("toppedDough",toppedDough,toppings,chefAddToppings,umlSD);
    ...
    /**
     * This method will contain all the code for initializing the buttons.
     */
    private void initButtons() {
        addClassButton = new Button("Add Class");
        addClassButton.setLayoutX(0);
        addClassButton.setLayoutY(0);
        addClassButton.setOnAction(e ->
                gen.setText("UMLSD Memory: " + umlSD)
        );
        layout.getChildren().add(addClassButton);
    }

    /**
     * This method will contain all the code for initializing labels.
     */
    private void initLabels() {
        gen = new Label();
        gen.setLayoutX(50);
        gen.setLayoutY(50);
        layout.getChildren().add(gen);
    }
